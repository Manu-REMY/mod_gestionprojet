...
/**
 * The mod_gestionprojet submission created event.
 *
...
/**
 * The mod_gestionprojet submission created event class.
 *
 * Fired when a student submits their work for a step.
 *
 * @package    mod_gestionprojet
 * @copyright  2026 Emmanuel REMY
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class submission_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_submission_created', 'gestionprojet');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' submitted step '{$this->other['step']}' " .
    ...
    public function get_url() {
        return new \moodle_url('/mod/gestionprojet/view.php', [
