...
// AI Log Report
$string['ai_log_report'] = 'AI Usage Report';
$string['ai_log_report_desc'] = 'View all AI evaluation requests and responses';
...
$string['all_providers'] = 'All providers';
$string['all_statuses'] = 'All statuses';
$string['summary_requests'] = '{$a} requests';
$string['summary_tokens'] = '{$a} tokens total';
$string['column_id'] = 'ID';
$string['column_datetime'] = 'Date/Time';
...
$string['expand_prompts'] = 'Show prompts';
$string['collapse_prompts'] = 'Hide prompts';
$string['prompt_system'] = 'System prompt';
$string['prompt_user'] = 'User prompt';
$string['ai_response'] = 'AI response';
$string['show_more'] = 'Show more';
$string['show_less'] = 'Show less';
$string['no_evaluations'] = 'No AI evaluations found';
$string['gestionprojet:viewailogs'] = 'View AI usage logs';
$string['export_csv'] = 'Export as CSV';
$string['prompt_not_recorded'] = 'Prompt not recorded (prior evaluation)';
...
$string['ai_progress_pending_student'] = 'AI evaluation queued…';
$string['ai_progress_processing_student'] = 'AI evaluation in progress…';
