...
/**
 * Step 2: Needs Expression (Horn Chart) - Teacher configuration page
 *
...
<script>
// Localized strings for SVG diagram
var DIAGRAM_STRINGS = {
    aquiTitle: <?php echo json_encode(get_string('diagram_aqui_title', 'gestionprojet')); ?>,
    aquiSubtitle: <?php echo json_encode(get_string('diagram_aqui_subtitle', 'gestionprojet')); ?>,
    surquoiTitle: <?php echo json_encode(get_string('diagram_surquoi_title', 'gestionprojet')); ?>,
    surquoiSubtitle: <?php echo json_encode(get_string('diagram_surquoi_subtitle', 'gestionprojet')); ?>,
    productLabel: <?php echo json_encode(get_string('diagram_product_label', 'gestionprojet')); ?>,
    productSubtitle: <?php echo json_encode(get_string('diagram_product_subtitle', 'gestionprojet')); ?>,
    dansquelbutTitle: <?php echo json_encode(get_string('diagram_dansquelbut_title', 'gestionprojet')); ?>,
    dansquelbutSubtitle: <?php echo json_encode(get_string('diagram_dansquelbut_subtitle', 'gestionprojet')); ?>
};
...
(function waitRequire() {
    ...
    require(['jquery', 'mod_gestionprojet/autosave'], function($, Autosave) {
        $(document).ready(function() {
            ...
            // Simplified Horn Chart SVG diagram
            ...
            function updateDiagram() {
                ...
                // Left ellipse - Who does it serve?
                ...
                leftTitle.textContent = DIAGRAM_STRINGS.aquiTitle;
                ...
                leftSubtitle.textContent = DIAGRAM_STRINGS.aquiSubtitle;
                svg.appendChild(leftSubtitle);

                // Right ellipse - What does it act on?
                ...
                rightTitle.textContent = DIAGRAM_STRINGS.surquoiTitle;
                ...
                rightSubtitle.textContent = DIAGRAM_STRINGS.surquoiSubtitle;
                ...
                productLabel.textContent = DIAGRAM_STRINGS.productLabel;
                ...
                productSubLabel.textContent = DIAGRAM_STRINGS.productSubtitle;
                svg.appendChild(productSubLabel);

                // Bottom rectangle - For what purpose?
                ...
                bottomTitle.textContent = DIAGRAM_STRINGS.dansquelbutTitle;
                ...
                bottomSubtitle.textContent = DIAGRAM_STRINGS.dansquelbutSubtitle;
