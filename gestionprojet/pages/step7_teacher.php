...
/**
 * Step 7 Teacher Correction Model: Student Needs Expression
 *
...
// Default AI instructions for needs expression (Horn Chart).
$defaultaiinstructions = get_string('ai_instructions_default_step7', 'gestionprojet');
...
echo $OUTPUT->render_from_template(
    ...
    gestionprojet_build_step_tabs($gestionprojet, $cm->id, 7, 'correction')
);

echo $OUTPUT->heading(
    get_string('step7', 'gestionprojet')
...
<div class="teacher-model-container gp-correction">
    ...
    <div class="teacher-model-header">
        <h2><?php echo icon::render('target', 'sm', 'purple'); ?> <?php echo get_string('step7', 'gestionprojet'); ?> - <?php echo get_string('correction_models', 'gestionprojet'); ?></h2>
    ...
    <form id="teacherModelForm">
        ...
        <div class="model-form-section">
            <h3><?php echo icon::render('target', 'sm', 'purple'); ?> <?php echo get_string('bete_a_corne_diagram', 'gestionprojet'); ?></h3>
