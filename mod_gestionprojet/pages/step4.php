...
$submission = gestionprojet_get_or_create_submission($gestionprojet->id, $groupid, 'gestionprojet_cdcf');
        ...
        <div class="project-section">
            <div class="project-name-container">
                <div class="project-name">
                    ...
                    <input type="text" id="produit" name="produit"
                           value="<?php echo s($submission->produit ?? ''); ?>"
            ...
            <div class="project-name">
                ...
                <input type="text" id="milieu" name="milieu"
                       value="<?php echo s($submission->milieu ?? ''); ?>"
